        ...
        <div className="bg-slate-50 min-h-screen">
            ...
            <section className="relative overflow-hidden py-24 bg-slate-900 text-white">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                    ...
                    <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                        Turning Dreams Into <span className="text-blue-500">Your New Reality</span>
                    </h1>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid md:grid-cols-2 gap-16 items-center">
                        ...
                        <div className="bg-white p-10 rounded-3xl shadow-sm border border-slate-200">
                            ...
                            <h2 className="text-3xl font-bold text-slate-900 mb-6">Why We Do It</h2>
            ...
            <section className="py-20 bg-white border-t border-slate-100">
                <div className="max-w-4xl mx-auto text-center px-4">
                    <h2 className="text-3xl font-bold text-slate-900 mb-6">Ready to Bridge the Gap?</h2>
