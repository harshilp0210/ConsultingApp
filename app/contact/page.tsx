                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 bg-slate-900 rounded-2xl shadow-lg border border-slate-800 p-8">
                        ...
                        <form className="space-y-6">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-amber-500 text-slate-950 font-bold py-4 rounded-xl hover:bg-amber-400 transition-all shadow-lg hover:shadow-amber-500/25 flex items-center justify-center gap-2 transform hover:-translate-y-0.5"
                            >
                                Start Consultation
