                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <a href="tel:+442071234567" className="text-blue-600 font-medium hover:underline">+44 20 7123 4567</a>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-slate-600 mb-1">Instant chat support</p>
                                <a href="https://wa.me/447123456789" className="text-green-600 font-medium hover:underline">Chat Now</a>
                            </div>
                        </div>
                        ...
                        <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-slate-600 mb-1">We reply within 24 hours</p>
                                <a href="mailto:info@ukvisaexperts.com" className="text-blue-600 font-medium hover:underline">info@ukvisaexperts.com</a>
                            </div>
                        </div>
                    ...
                    <div className="lg:col-span-2 bg-white rounded-2xl shadow-lg border border-slate-100 p-8">
                        ...
                        <form className="space-y-6">
                            ...
                            <div>
                                <label htmlFor="visaType" className="block text-sm font-medium text-slate-700 mb-1">Visa Type Interest</label>
                                <select
                                    id="visaType"
                            ...
                            <button
                                type="submit"
                                className="w-full bg-blue-900 text-white font-bold py-4 rounded-lg hover:bg-blue-800 transition-all shadow-lg hover:shadow-blue-900/25 flex items-center justify-center gap-2"
                            >
                                Start Consultation
