                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col md:flex-row items-center gap-12">
                    <div className="md:w-1/2">
                        ...
                        <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight">
                            Unlock Your Future with a <span className="text-amber-500">UK Degree</span>
                        </h1>
                    ...
                    <div className="md:w-1/2 bg-slate-950/50 backdrop-blur-sm rounded-2xl p-8 border border-white/10 shadow-2xl">
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="font-bold text-lg text-white">Up to £10,000 Scholarship</p>
                            ...
                            <li className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="font-bold text-lg text-white">Offer Letter Within 72 Hours</p>
                            ...
                            <li className="flex items-center gap-4">
                                ...
                                <div>
                                    <p className="font-bold text-lg text-white">140+ Partnered Universities</p>
                    ...
                    <div className="grid md:grid-cols-2 gap-16">
                        ...
                        <div>
                            ...
                            <div className="bg-slate-900 rounded-2xl shadow-sm border border-slate-800 p-8">
                                <ul className="grid sm:grid-cols-2 gap-y-4 gap-x-8">
                                    ...
                                    <li className="col-span-full pt-4 text-amber-500 font-semibold italic">
                        ...
                        <div className="space-y-8">
                            <div className="bg-slate-900 border border-slate-800 text-white rounded-2xl p-8 shadow-xl">
                                <h3 className="text-2xl font-bold mb-4 text-amber-500">Accepting English Tests</h3>
                                <p className="mb-6 opacity-90 text-slate-300">We help you prepare and apply with scores from all major accepted providers.</p>
                                <div className="flex flex-wrap gap-3">
                                    <span className="px-4 py-2 bg-slate-800 border border-slate-700 rounded-lg font-bold hover:border-amber-500 transition-colors">IELTS</span>
                                    <span className="px-4 py-2 bg-slate-800 border border-slate-700 rounded-lg font-bold hover:border-amber-500 transition-colors">PTE</span>
                                    <span className="px-4 py-2 bg-slate-800 border border-slate-700 rounded-lg font-bold hover:border-amber-500 transition-colors">Duolingo</span>
                                </div>
                            </div>

                            <div className="bg-amber-500 rounded-2xl p-8 shadow-lg shadow-amber-500/10">
                                <h3 className="text-2xl font-bold text-slate-950 mb-4">Start Your Journey Today</h3>
