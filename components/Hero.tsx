...
export default function Hero() {
    return (
        <div className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden bg-slate-50">
            {/* Background Decor */}
            <div className="absolute top-0 right-0 -translate-y-12 translate-x-12 w-[600px] h-[600px] bg-blue-100/50 rounded-full blur-3xl opacity-60 pointer-events-none"></div>
            <div className="absolute bottom-0 left-0 translate-y-24 -translate-x-24 w-[500px] h-[500px] bg-indigo-100/50 rounded-full blur-3xl opacity-60 pointer-events-none"></div>
                ...
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="space-y-8 animate-in slide-in-from-left-4 fade-in duration-1000 max-w-2xl">
                        ...
                        <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-slate-900 leading-[1.1]">
                            Your Gateway to <br />
                            <span className="text-blue-600">the UK.</span>
                        </h1>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            <Link
                                href="/contact"
                                className="inline-flex justify-center items-center px-8 py-4 text-base font-bold text-white bg-blue-600 rounded-full hover:bg-blue-700 transition-all shadow-lg shadow-blue-600/25 active:scale-95"
                            >
                                Start Application
                            ...
                            <Link
                                href="#services"
                                className="inline-flex justify-center items-center px-8 py-4 text-base font-bold text-slate-600 bg-white border border-slate-200 rounded-full hover:bg-slate-50 hover:text-slate-900 transition-all shadow-sm active:scale-95"
                            >
                                Explore Services
                            </Link>
                        </div>
                    ...
                    <div className="relative lg:ml-auto animate-in slide-in-from-right-4 fade-in duration-1000 delay-200 w-full">
                        <div className="relative rounded-2xl overflow-hidden aspect-[4/5] md:aspect-square lg:aspect-[4/5] bg-white border border-slate-200 shadow-2xl">
                            <div className="absolute inset-0 bg-gradient-to-br from-blue-50 to-white/50"></div>

                            {/* Abstract UI Representation */}
                            <div className="absolute inset-0 p-8 flex flex-col justify-center items-center">
                                {/* Card 1 */}
                                <div className="w-full max-w-xs bg-white rounded-xl shadow-xl border border-slate-100 p-6 mb-6 transform -rotate-3 transition-transform hover:rotate-0 duration-300">
                                    <div className="flex items-center gap-4 mb-4">
                                        <div className="w-12 h-12 bg-green-100 rounded-full flex items-center justify-center text-green-600">
                                            <CheckCircle2 className="w-6 h-6" />
                                        </div>
                                        <div>
                                            <h3 className="font-bold text-slate-900">Visa Approved</h3>
                                ...
                                {/* Card 2 */}
                                <div className="w-full max-w-xs bg-white rounded-xl shadow-xl border border-slate-100 p-6 transform rotate-3 transition-transform hover:rotate-0 duration-300 relative z-10">
                                    <div className="flex items-center gap-4 mb-4">
                                        <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center text-blue-600">
                                            <ShieldCheck className="w-6 h-6" />
                                        </div>
                                        <div>
                                            <h3 className="font-bold text-slate-900">Document Verified</h3>
